...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="navbar-brand m-auto" href="{{url('/')}}">
                <img src="assets/imgs/logo2.jpg" class="brand-img" alt="">
                <span class="brand-txt">Conchita Cocina</span>
            </a>
            <ul class="navbar-nav">
                <li class="nav-item">
    ...
    <div id="gallary" class="text-center bg-dark text-light has-height-md middle-items wow fadeIn">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a onclick="return confirm('Confirm remove?')" class="btn btn-danger" href="{{url('remove_cart', $data->id)}}">Remove</a>
                </td>
            </tr>
        ...
        <h3>Total price in the Cart ₱{{$total_price}}</h3>
